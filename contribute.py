...
def arguments(argsval):
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="leooking",
                        help="""Overrides user.name git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="magehire@gmail.com",
